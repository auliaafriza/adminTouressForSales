          ...
          <Container widthContainer={fullWidth}>
                      ...
                      ? Data.ProfileFacilities.slice(0, 4).map((Aloc, i) => {
                          return i < 6 ? (
                            ...
                            >
                              ...
                              />
                              <Text
                                style={[styles.text12NoBold, styles.textCenter]}
                              >
                                {Aloc.Name}
                              </Text>
                            </View>
            ...
            this.props.dataRoom
              ? this.props.dataRoom.length != 0
                ...
                : dummyProfileAccommodation.map((hotel, i) => {
                    return (
                      <View
                        style={(styles.rowNoPadding, styles.colPadding20)}
                        key={i}
...
const mapStateToProps = state => ({
  data: state.accommodationReducer.accommodationById,
  dataRoom: state.accommodationReducer.accommodationRooms,
  isDataRoom: state.accommodationReducer.accommodationByIdStatus,
});
