                    ...
                    >
                      ...
                      >
                        <Text style={styles.textInfo}>
                          {this.props.tourOperatorId
                            ? this.props.tourOperatorId.Name
                            : ''}
                        </Text>
                        <Text style={styles.textInfo}>
                          Region:{' '}
                          {this.props.tourOperatorId
                            ? this.props.tourOperatorId.RegionName
                            : ''}
                        </Text>
                        <Text style={styles.textInfo}>
                          {this.props.tourOperatorId
                            ? this.props.tourOperatorId.Telephone
                            : ''}
                        </Text>
                        <Text style={styles.textInfo}>
                          {this.props.tourOperatorId
                            ? this.props.tourOperatorId.Email
                            : ''}
                        </Text>
                      </View>
                    </View>
